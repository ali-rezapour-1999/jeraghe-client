...
const CartItem: React.FC<CartItemProps> = ({ onOpen }) => {
  return (
    <div
      onClick={onOpen}
      className="border-1 p-5 rounded-2xl hover:shadow-md transition-shadow cursor-pointer"
    >
      <div className="flex items-center gap-3 border-b-1 pb-3 mb-3">
      ...
      <div className="border-t-1 mt-3 pt-5 flex justify-between">
